...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, }, "Up", function(c)
        ...
        { description = "Resize Vertical Up", group = "client" }),
    ...
    awful.key({ modkey, }, "Down", function(c)
        ...
        { description = "Resize Vertical Down", group = "client" }),
    ...
    awful.key({ modkey, }, "Left", function(c)
        ...
        { description = "Resize Horizontal Left", group = "client" }),
    ...
    awful.key({ modkey, }, "Right", function(c)
        ...
        { description = "Resize Horizontal Right", group = "client" })
)
